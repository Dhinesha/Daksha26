        ...
        <div className="flex flex-col items-center justify-center mb-20">
          ...
          <div className="relative w-[320px] h-[320px] sm:w-[480px] sm:h-[480px] md:w-[580px] md:h-[580px] lg:w-[680px] lg:h-[680px] flex items-center justify-center">
            ...
            <div className="absolute inset-0 opacity-10 pointer-events-none" 
                 style={{ backgroundImage: `radial-gradient(#0ea5e9 0.5px, transparent 0.5px)`, backgroundSize: '20px 20px' }} />
            ...
            >
              ...
              <svg viewBox="0 0 100 100" className="w-full h-full overflow-visible">
                ...
                {/* Main Wheel Body */}
                <circle cx="50" cy="50" r="48" fill="url(#cyberGradient)" stroke="#0ea5e9" strokeWidth="0.2" strokeDasharray="1 2" />
                <circle cx="50" cy="50" r="40" fill="none" stroke="#0ea5e9" strokeWidth="0.1" opacity="0.3" />
                
                {/* Degree Markers */}
                {[...Array(36)].map((_, i) => (
                  <line
                    key={i}
                    x1="50" y1="2" x2="50" y2={i % 9 === 0 ? 6 : 4}
                    ...
                    <g key={i}>
                      ...
                      {isSelected && (
                        <motion.circle
                          ...
                          fill="#22d3ee"
                          animate={{
                            cx: [50, 50 + 48 * Math.cos((angle * Math.PI) / 180)],
                            cy: [50, 50 + 48 * Math.sin((angle * Math.PI) / 180)],
                            opacity: [0, 1, 0]
                          }}
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      <div className={`absolute -inset-2 rounded-full border border-dashed transition-all duration-500 ${
                        isSelected ? 'border-secondary animate-spin-slow opacity-100' : 'border-primary/20 opacity-0 group-hover:opacity-50'
                      }`} />
                      ...
                      >
                        ...
                        <div className={`absolute inset-0 transition-colors duration-500 ${
                          isSelected ? 'bg-secondary/10' : 'bg-black/50 group-hover:bg-black/20'
                        }`} />
                        
                        <div className="absolute inset-0 flex items-center justify-center p-2">
                          <span className={`text-[8px] sm:text-[10px] md:text-xs lg:text-sm font-orbitron font-bold text-center leading-tight uppercase tracking-tighter transition-colors duration-500 ${
              ...
              <div className="relative w-28 h-28 sm:w-36 sm:h-36 md:w-44 md:h-44 lg:w-52 lg:h-52">
                ...
                <div className="absolute inset-4 rounded-full bg-[#020617] border border-secondary/50 flex flex-col items-center justify-center shadow-[0_0_30px_rgba(34,211,238,0.3),inset_0_0_20px_rgba(34,211,238,0.2)] overflow-hidden">
                  ...
                  <motion.img
                    ...
                    animate={{ 
                      scale: [1, 1.05, 1],
                      filter: ["drop-shadow(0 0 0px rgba(34,211,238,0))", "drop-shadow(0 0 15px rgba(34,211,238,0.5))", "drop-shadow(0 0 0px rgba(34,211,238,0))"]
                    }}
                    transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}
                  />
                  <div className="relative z-10 text-[8px] sm:text-[10px] text-gray-400 uppercase tracking-[0.3em] mt-1">2025</div>
                  ...
                  <div className="relative overflow-hidden bg-slate-900/50 border border-white/10 rounded-lg aspect-square cursor-pointer group-hover:border-secondary/50 transition-all duration-500">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6 transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500 z-20">
                      <div className="flex items-center justify-between">
                        <span className="text-xs font-orbitron text-secondary tracking-widest uppercase">Register Now</span>
                        <motion.div
                          animate={{ x: [0, 5, 0] }}
                          transition={{ duration: 1.5, repeat: Infinity }}
                        >
