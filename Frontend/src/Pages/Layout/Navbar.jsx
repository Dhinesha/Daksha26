...
const Navbar = () => {
  ...
  useEffect(() => {
    ...
    else if (path === "/register") setActiveLink("Register");
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <div className="flex items-center gap-4 ml-4">
                <button 
                  ...
                  className="text-white/90 hover:text-secondary transition-colors font-orbitron text-sm tracking-widest"
                >
                  LOGIN
                </button>
                <motion.button
            ...
            >
              <div className="px-4 pt-2 pb-6 space-y-1">
                ...
                <div className="pt-4 flex flex-col gap-3 px-4">
                  <button 
                    onClick={() => handleLinkClick("Dashboard", "/dashboard")}
                    className="w-full py-3 text-center font-orbitron tracking-widest text-white border border-white/20 rounded-lg"
                  >
                    LOGIN
                  </button>
                  <button
